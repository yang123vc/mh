            ...
            v = {
                init: function(b, c) {
                    this._super(b, a.extend(!0, {
                        ...
                        down: {
                            height: 50,
                            contentinit: "ä¸‹æ‹‰å¯ä»¥åˆ·æ–°",
                            contentdown: "ä¸‹æ‹‰å¯ä»¥åˆ·æ–°",
                            contentover: "é‡Šæ”¾ç«‹å³åˆ·æ–°",
                            contentrefresh: "æ­£åœ¨åˆ·æ–°..."
                        },
                        up: {
                            height: 50,
                            auto: !1,
                            contentinit: "ä¸Šæ‹‰æ˜¾ç¤ºæ›´å¤š",
    ...
    function(a, b) {
        a.alert = function(c, d, e, f) {
            if(a.os.plus) {
                ...
                "function" == typeof d ? (f = d, d = null, e = "ç¡®å®š") : "function" == typeof e && (f = e, e = null), a.plusReady(function() {
        ...
        var c = "mui-active",
            ...
            f = function(c, d) {
                if(this.element = c, this.options = a.extend({
                        ...
                        duration: 16,
                        scrollby: b
                    }, d || {}), this.scrollByElem = this.options.scrollby || b, !this.scrollByElem) throw new Error("ç›‘å¬æ»šåŠ¨çš„å…ƒç´ ä¸å­˜åœ¨");
                ...
                if(!f.length) throw new Error("å…ƒç´ èƒŒæ™¯é¢œè‰²å¿…é¡»ä¸ºRGBA");
    ...
    function(a) {
        var b = "ontouchstart" in document,
            ...
            i = a.Numbox = a.Class.extend({
                init: function(b, c) {
                    var d = this;
                    if(!b) throw "æž„é€  numbox æ—¶ç¼ºå°‘å®¹å™¨å…ƒç´ ";
